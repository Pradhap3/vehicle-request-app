...
const LocationPermissionPrompt = ({ onRequestPermission, permissionStatus, loading }) => {
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
      ...
      <h2 className="text-2xl font-bold text-gray-800 mb-3">Enable Location Sharing</h2>
      
      <p className="text-gray-600 mb-6 max-w-md mx-auto">
        To provide real-time tracking and efficient cab allocation, we need access to your location.
        This helps employees know when their cab will arrive.
      </p>
...
const PassengerCard = ({ passenger, onBoard, onNoShow, loading }) => {
  return (
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{passenger.pickup_location || 'Default pickup'}</p>
          </div>
        </div>
        <span className={`px-2 py-1 rounded-full text-xs font-medium ${
          passenger.is_boarded ? 'bg-green-100 text-green-800' :
          passenger.is_dropped ? 'bg-blue-100 text-blue-800' :
          'bg-yellow-100 text-yellow-800'
        }`}>
          {passenger.is_boarded ? 'Boarded' : passenger.is_dropped ? 'Dropped' : 'Waiting'}
        </span>
      </div>

      {!passenger.is_boarded && !passenger.is_dropped && (
...
const DriverDashboardPage = () => {
  ...
  // Show location permission prompt if not granted
  if (permissionStatus !== 'granted') {
    return (
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Your Cab</h2>
          ...
          {dashboard?.cab ? (
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500">{dashboard.cab.capacity} seats</p>
                </div>
              </div>
            ...
            <div className="text-center py-8 text-gray-500">
              ...
              <p>No cab assigned to you</p>
              <p className="text-sm">Contact HR to get a cab assigned</p>
            </div>
          )}
        </div>
        ...
        {/* Location Tracking */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Location Tracking</h2>
          ...
          <div className="space-y-4">
            ...
            {isTracking && (
              <p className="text-center text-sm text-green-600 flex items-center justify-center gap-2">
                ...
                Location is being shared in real-time
              </p>
            )}
          </div>
        </div>
      ...
      {dashboard?.route && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Today's Route</h2>
          <div className="flex items-center gap-4">
          ...
          {dashboard.route.estimated_time_minutes && (
            <p className="text-sm text-gray-500 mt-2 flex items-center gap-2">
              <Clock size={14} />
              Estimated time: {dashboard.route.estimated_time_minutes} minutes
            </p>
          )}
        </div>
      )}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h2 className="text-lg font-semibold text-gray-800 mb-4">
          Passengers ({dashboard?.passengers?.length || 0})
        </h2>
